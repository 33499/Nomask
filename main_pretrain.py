...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=3200, type=int)
    ...
    parser.add_argument('--output_dir', default='./output_dir_128',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir_128',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda:0',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='output_dir_128/checkpoint-latest.pth',
